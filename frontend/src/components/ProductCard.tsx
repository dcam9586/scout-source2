  ...
  return (
    ...
    >
      ...
      <div className="product-card__content">
        ...
        {/* Supplier & Rating */}
        <div className="product-card__supplier" title={supplier}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <span className="product-card__supplier-name">{supplier}</span>
            {supplierVerified && (
              <span className="product-card__verified-badge" title="Verified Supplier">
          ...
          {supplierAddress && (
            <div className="product-card__supplier-address" style={{ fontSize: '0.75rem', color: '#6b7280', display: 'flex', alignItems: 'center', gap: '4px', marginTop: '2px' }}>
