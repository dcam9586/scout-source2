  ...
  return (
    <div className="results-table-container">
        ...
        <table>
          <thead>
            <tr>
              ...
              <th className="results-table__th results-table__th--supplier">Supplier Info</th>
            ...
            {results.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="results-table__td results-table__td--supplier">
                    <div className="results-table__supplier-info">
                      <div className="results-table__supplier-name">
                        {product.supplier}
                        {product.supplierVerified && (
                          <span className="results-table__verified-badge" title="Verified Supplier">
                      ...
                      {product.supplierAddress && (
                        <div className="results-table__supplier-address" title={product.supplierAddress}>
                          {product.supplierAddress.length > 30 
                            ? `${product.supplierAddress.substring(0, 27)}...` 
                            : product.supplierAddress}
                        </div>
                      )}
                    </div>
          ...
          return (
            <div key={product.id} className="results-card">
              ...
              <div className="results-card__content">
                ...
                <p className="results-card__supplier">
                  {product.supplier}
                  {product.supplierVerified && (
                    <span className="results-table__verified-badge" title="Verified Supplier" style={{ marginLeft: '4px', display: 'inline-flex', verticalAlign: 'middle' }}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                        <polyline points="22 4 12 14.01 9 11.01" />
                      </svg>
      ...
      {onPageChange && totalCount > pageSize && (
        <div className="results-table__pagination" style={{ display: 'flex', gap: '8px', marginTop: '24px', justifyContent: 'center', padding: '16px 0' }}>
          <button 
          ...
          <button 
            ...
            style={{ 
              ...
              borderRadius: '4px', 
              border: '1px solid #ddd', 
              background: currentPage >= Math.ceil(totalCount / pageSize) ? '#f5f5f5' : 'white', 
