        ...
        productElements.forEach((el: any, index: number) => {
          ...
          try {
            ...
            items.push({
              ...
              supplierAddress: el.querySelector('[class*="address"], [class*="location"], .search-card-e-supplier__location')?.textContent?.trim() || '',
              supplierVerified: !!el.querySelector('.search-card-e-supplier__verified, [class*="verified"], [class*="trust"]'),
            });
          } catch (err) {
